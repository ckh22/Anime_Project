...
const InputField = React.forwardRef((props, ref) => { // Let's use splitFormProps to get form-specific props
...
const AnimeForm = () => {
    ...
    return (
        <Form style={{position: 'relative', zIndex: '10', padding: '15px'}}>
            <div>
                <label>
                    Name:
            ...
            <div>
                <label>
                    Address Street:{" "}
                    <InputField field="address.street"
